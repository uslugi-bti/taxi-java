...
public class ManualTest {
    public static void main(String[] args) {
        ...
        System.out.println("  Очікувано: СТАНДАРТНА_ПОЇЗДКА -> " + (action1.equals("СТАНДАРТНА_ПОЇЗДКА") ? "TRUE" : "FALSE"));
        ...
        System.out.println("  Очікувано: СТАНДАРТНА_ПОЇЗДКА -> " + (action2.equals("СТАНДАРТНА_ПОЇЗДКА") ? "TRUE" : "FALSE"));
        ...
        System.out.println("  Очікувано: ЗАДОРОГО_ДЛЯ_КОРОТКОЇ_ПОЇЗДКИ -> " + (action3.equals("ЗАДОРОГО_ДЛЯ_КОРОТКОЇ_ПОЇЗДКИ") ? "TRUE" : "FALSE"));
        ...
        System.out.println("  Очікувано: ЕКОНОМ_РЕКОМЕНДОВАНО -> " + (action4.equals("ЕКОНОМ_РЕКОМЕНДОВАНО") ? "TRUE" : "FALSE"));
        ...
        System.out.println("  Очікувано: ПОТРІБНА_ЗНИЖКА -> " + (action5.equals("ПОТРІБНА_ЗНИЖКА") ? "TRUE" : "FALSE"));
